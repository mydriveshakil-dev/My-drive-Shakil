  ...
  return (
    <div className="space-y-6 pb-28 pt-2 px-3 sm:px-6 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <GlassContainer
        variant="card"
        blur="3xl"
        className="p-4 sm:p-6 rounded-3xl border-2 border-black shadow-xl bg-white text-slate-900"
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-black text-white flex items-center justify-center border-2 border-black shadow-md shrink-0">
          ...
          <div className="flex items-center gap-2">
            <span className="bg-slate-100 text-slate-900 font-black text-xs px-3 py-1.5 rounded-2xl border border-black shadow-xs flex items-center gap-1.5">
