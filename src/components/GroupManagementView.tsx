      ...
      >
        <div>
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            {isAdmin ? (
              <span className="bg-black text-white text-xs font-black px-3 py-1 rounded-full border border-black flex items-center gap-1 shadow-md">
              ...
              <span
                ...
                className="bg-white hover:bg-slate-100 text-slate-900 text-xs font-bold px-3 py-1 rounded-full border border-black flex items-center gap-1 cursor-pointer transition-all"
              >
